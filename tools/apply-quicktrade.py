#!/usr/bin/env python3
"""Build 27: QUICK TRADE (key 7, 900c) in the main game - swap one plain piece for any other, paying the difference."""
import sys
...
open(DST,'w').write(src); print('quick trade applied',n)
